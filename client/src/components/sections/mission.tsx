...
import { ScrollReveal, ScrollRevealLeft, StaggerContainer, StaggerItem, HoverLift } from "@/lib/animations";
            ...
            {values.map((value, index) => {
              ...
              return (
                <StaggerItem key={index}>
                  <HoverLift>
                    <Card className="bg-card h-full glass-card" data-testid={`card-value-${index}`}>
